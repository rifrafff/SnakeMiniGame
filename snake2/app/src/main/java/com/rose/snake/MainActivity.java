...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGameView.setGameScoreUpdatedListener(score -> {
            mHandler.post(() -> mGameScoreText.setText("SKOR: " + score));
        });
    ...
    private void setGameStatus(int gameStatus) {
        ...
        mGameBtn.setText("başla");
        mGameStatus.set(gameStatus);
        switch (gameStatus) {
            case STATUS_OVER:
                mGameStatusText.setText("OYUN BİTTİ");
                break;
            case STATUS_START:
                mGameView.newGame();
                mGameStatusText.setText("OYUNU BAŞLAT");
                break;
            case STATUS_PAUSED:
                mGameStatusText.setText("OYUN DURDURULDU");
                break;
            case STATUS_PLAYING:
